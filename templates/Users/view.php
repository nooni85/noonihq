    ...
    <div class="column column-80">
        <div class="users view content">
            ...
            <table>
                ...
                <tr>
                    <th><?= __('Users Profile Img') ?></th>
                    <td><?= $user->hasValue('userProfileImg') ? $this->Html->link($user->userProfileImg->path, ['controller' => 'UsersProfileImg', 'action' => 'view', $user->userProfileImg->no]) : '' ?></td>
                </tr>
                <tr>
                    <th><?= __('Id') ?></th>
