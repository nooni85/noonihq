...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $usersprofileimg->no],
                ['confirm' => __('Are you sure you want to delete # {0}?', $usersprofileimg->no), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="usersprofileimg form content">
            ...
            <fieldset>
                <legend><?= __('Edit Usersprofileimg') ?></legend>
                <?php
